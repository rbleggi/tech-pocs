...
case class ClassSession(
  ...
  def duration: Long = Duration.between(startTime, endTime).toMinutes
...
class ResourceMonitor extends Observer:
  private val availableRooms: Set[String] = Set("A101", "A102", "B201", "B202", "C301")
...
@main def runClassOrganizer(): Unit =
